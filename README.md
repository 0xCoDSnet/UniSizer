...
1. Необходимо установить **Python версии 3.9 или выше**.
2. Установите зависимости, выполнив команду `python3 -m pip install -r requirements.txt`.
3. Для запуска программы выполните команду `python3 UniSizer.py`.
